...
public class CardScaleHelper {
    ...
    public CardScaleHelper(float scale,int pagePadding,int LeftCardWith){
        mScale=scale;
        mPagePadding=pagePadding;
        mShowLeftCardWidth=LeftCardWith;
    }
    ...
    private void initWidth() {
        mRecyclerView.post(new Runnable() {
            ...
            public void run() {
                ...
                mCardWidth = mCardGalleryWidth - CommonUtils.px(mContext, 2 * (mPagePadding + mShowLeftCardWidth));
